...
import xplatj.gdxplat.pursuer.decoder.internal.Mp3Decoder2;
...
public class Mp3AudioInfo extends RewindSeekAudio {
	...
	public boolean loadRaw(IDataBlock raw) {
		...
		try {
			mp3 = new Mp3Decoder2.Music(dbin);
