package xplatj.gdxplat.com.rpsg.lazyFont;
...
public class LazyBitmapFont extends BitmapFont {
	...
	public LazyBitmapFont(FreeTypeFontGenerator generator, int fontSize) {
		super(new BitmapFont.BitmapFontData(), new Array<TextureRegion>(new TextureRegion[]{new TextureRegion()}),false);
		if (generator == null)
	...
	public static class LazyBitmapFontData extends FreeTypeBitmapFontData {
		...
		protected Glyph generateGlyph(char ch) {
			...
			Pixmap map = gab.bitmap.getPixmap(Format.RGBA4444, Color.WHITE, 1f);
