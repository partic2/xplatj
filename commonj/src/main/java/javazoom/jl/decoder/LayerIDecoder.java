...
public class LayerIDecoder implements FrameDecoder {
	...
	protected void readSampleData() {
		...
		do {
			...
			do {
				for (i = 0; i < num_subbands; ++i)
					write_ready = subbands[i].put_next_sample(which_channels, filter1,
							filter2);
	...
	static final float scalefactors[] = { 2.00000000000000f, 1.58740105196820f,
			...
			0.00000120155435f, 0.00000000000000f
	/*
	 * illegal scalefactor
	 */
	};
