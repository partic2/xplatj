...
class Floor1 extends FuncFloor {
	...
	Object look(DspState vd, InfoMode mi, Object i) {
		...
		/*
		 * we drop each position value in-between already decoded values, and use
		 * linear interpolation to predict each new value past the edges. The
		 * positions are read in the order of the position list... we precompute the
		 * bounding positions in the lookup. Of course, the neighbors can change (if
		 * a position is declined), but this is an initial mapping
		 */
	...
	private static float[] FLOOR_fromdB_LOOKUP = { 1.0649863e-07F,
			...
			0.0073652516F, 0.0078438871F, 0.0083536271F, 0.0088964928F, 0.009474637F,
			0.010090352F, 0.010746080F, 0.011444421F, 0.012188144F, 0.012980198F,
			0.013823725F, 0.014722068F, 0.015678791F, 0.016697687F, 0.017782797F,
			0.018938423F, 0.020169149F, 0.021479854F, 0.022875735F, 0.024362330F,
			0.025945531F, 0.027631618F, 0.029427276F, 0.031339626F, 0.033376252F,
			0.035545228F, 0.037855157F, 0.040315199F, 0.042935108F, 0.045725273F,
			0.048696758F, 0.051861348F, 0.055231591F, 0.058820850F, 0.062643361F,
			0.066714279F, 0.071049749F, 0.075666962F, 0.080584227F, 0.085821044F,
