...
class Mapping0 extends FuncMapping {
	...
	void pack(Info vi, Object imap, Buffer opb) {
		...
		/*
		 * another 'we meant to do it this way' hack... up to beta 4, we packed 4
		 * binary zeros here to signify one submapping in use. We now redefine that
		 * to mean four bitflags that indicate use of deeper features;
