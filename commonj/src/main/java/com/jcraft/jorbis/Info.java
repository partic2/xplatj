...
public class Info {
	...
	int unpack_books(Buffer opb) {
		...
		for (int i = 0; i < residues; i++) {
			...
			residue_param[i] = FuncResidue.residue_P[residue_type[i]].unpack(this,
					opb);
	...
	public String toString() {
		return "version:" + new Integer(version) + ", channels:"
				+ new Integer(channels) + ", rate:" + new Integer(rate) + ", bitrate:"
				+ new Integer(bitrate_upper) + "," + new Integer(bitrate_nominal) + ","
